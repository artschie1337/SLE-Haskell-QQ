...
(defn component [baseuri section move-up move-down is-first is-last]
       ...
       (if @headline-edit?
         ...
         [:div {:class "card-header section-card-header"}
          [:p {:class "card-header-title"}
           @headline]
          [:a {:class "card-header-icon" :on-click move-up :disabled is-first}
           [:span {:class "icon"}
            [:i {:class "far fa-arrow-alt-circle-up"}]]]
          [:a {:class "card-header-icon" :on-click move-down :disabled is-last}
           [:span {:class "icon"}
